function globaly()
{
 let sending_buttons = document.querySelector(".disappear");
  sending_buttons.toggleAttribute("hidden");
 let showing = document.querySelector("#globaly_det");
  showing.toggleAttribute("hidden");
  let final_check = document.querySelector(".checking_button");
 final_check.style.visibility = "visible"
}
...
function continent(e) {
 ...
 switch (continent_choice) {
     case 'Euroupe':
         ...
         label_menu.style.fontSize = "x-large";
     ...
     case "Asia":
       console.log("He chose Asia");
         ...
         Asia_label_menu.style.fontSize = "x-large";
...
function documents()
 { 
   document.querySelector("#pac").style.visibility="collapse";
   document.querySelector("#docu").style.visibility ="collapse";

   let label_docu = document.createElement("label");
   label_docu.textContent= "number of documents";
   label_docu.classList.add("address_label","third_group_box");

   let num_docs = document.createElement("input");
   num_docs.setAttribute("type","number");
   num_docs.setAttribute("minlength",4);
   num_docs.classList.add( "docs_numbers","contenents_cho","third_group_box");
   num_docs.style.width ="142px";
...
function fin_check(){
 ...
 if (document.querySelector(".contenents_cho").value === "not_choice") {
   alert("chooseyour continent first");
 }
 else if (document.querySelector(".contenents_cho").value !== "not_choice" && window.getComputedStyle(document.querySelector("#docu")).visibility
 !== "collapse" ) {
   alert("choose wether you want to send documents or packages first")
 }
 else{
